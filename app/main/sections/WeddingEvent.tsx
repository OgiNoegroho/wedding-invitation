...
export default function WeddingEvent() {
  const target = new Date(2026, 0, 3, 8, 0, 0);
      ...
      <div className="max-w-6xl mx-auto text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-24">
          ...
          >
            ...
            <p className="max-w-sm mx-auto text-gray-600 leading-relaxed">
              Jl. Kesuma Komplek Peputra Indah 1 Blok C No 37, Simpang Tiga,
          ...
          >
            ...
            <p className="text-gray-700 mb-2">3 Januari 2026</p>
            <p className="text-gray-700 mb-6">11.00 s/d Selesai</p>
            <p className="max-w-sm mx-auto text-gray-600 leading-relaxed">
              Jl. Utama, Desa Batu Belah, Samping Masjid Baiturrahman (Kediaman
              Mempelai Pria)
            </p>
          </motion.div>
        </div>
        ...
        >
          ...
          <div className="flex justify-center gap-4 flex-wrap">
            {timeLeft.finished ? (
              <p className="text-2xl font-semibold">Acara Dimulai / Selesai</p>
            ) : (
              <>
